...
(function (l) {
      ...
      return (
        a.iDrawError != e &&
          ...
          (da(
            a,
            0,
            "Requested unknown parameter " + ("function" == typeof h.mData ? "{function}" : "'" + h.mData + "'") + " for row " + b + ", column " + c,
            4
          ),
          (a.iDrawError = e)),
        g
  ...
  function Fb(a) {
    ...
    for (b = g.length; k < b; k++) {
      ...
      h && n.appendTo(c);
      a.oFeatures.bSort &&
        (n.addClass(m.sSortingClass), !1 !== m.bSortable && (n.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), fb(a, m.nTh, k)));
