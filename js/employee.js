window.addEventListener("load", function () {
  let employeeFirstName = localStorage.getItem("employee_firstname");

  let employeeLastName = localStorage.getItem("employee_lastname");
  this.document.getElementById("EmployeeName").innerText = `${employeeFirstName} ${employeeLastName}`;
  let userId = this.localStorage.getItem("employee_userId");
